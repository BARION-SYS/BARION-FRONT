...
function SelectContent({
  ...
  align = "center",
  alignOffset = 0,
  // false: dropdown estilo popover — el modo "alinear con el trigger" rompe el scroll dentro de modales
