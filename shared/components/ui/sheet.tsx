  ...
  return (
    <SheetPortal>
      ...
      <SheetPrimitive.Popup
        ...
        data-side={side}
        className={cn(
          // Afinado para Barion: el panel entra y sale con `motion`, no con
          // transiciones CSS — las clases `data-*-style` de shadcn se retiraron
          // porque pintan su propio `translate` encima del que anima motion.
          // El ancho tampoco se fija aquí: lo decide el shell que lo compone,
          // y a lo ancho de un móvil ocupa la pantalla entera.
